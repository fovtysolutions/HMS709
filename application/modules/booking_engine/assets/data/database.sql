...
CREATE TABLE `tbl_booking_engine_paid` (`id` INT(11) NOT NULL AUTO_INCREMENT ,
 `aid` INT NOT NULL , `uid` INT NOT NULL , `service_name` VARCHAR(255) NULL DEFAULT NULL , 
 `service_amount` DECIMAL(20,2) NULL DEFAULT NULL , `tax` DECIMAL(10,2) NULL DEFAULT NULL ,
  `image` VARCHAR(255) NULL DEFAULT NULL , `description` TEXT NULL DEFAULT NULL ,
 `created_at` TIMESTAMP NULL DEFAULT NULL , `updated_at` TIMESTAMP NULL DEFAULT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB 
 AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 COLLATE latin1_general_ci;